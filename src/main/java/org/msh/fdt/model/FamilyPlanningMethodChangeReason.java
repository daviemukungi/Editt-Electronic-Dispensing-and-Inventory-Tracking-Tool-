...
/**
 * Created by kenny on 9/5/14.
 */
@Entity
@Table(name = "family_planning_method_change_reason", schema = "", catalog = "fdt")
public class FamilyPlanningMethodChangeReason {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        FamilyPlanningMethodChangeReason that = (FamilyPlanningMethodChangeReason) o;
