 ...
 */
@Entity
@Table(name = "drug_form", schema = "", catalog = "fdt")
public class DrugForm {
    ...
    public boolean equals(Object o) {
        ...
        if (createdBy != drugForm.createdBy) return false;
        if (id != drugForm.id) return false;
        if (voided != drugForm.voided) return false;
        if (createdOn != null ? !createdOn.equals(drugForm.createdOn) : drugForm.createdOn != null) return false;
        if (description != null ? !description.equals(drugForm.description) : drugForm.description != null)
            return false;
        if (name != null ? !name.equals(drugForm.name) : drugForm.name != null) return false;
        if (updatedBy != null ? !updatedBy.equals(drugForm.updatedBy) : drugForm.updatedBy != null) return false;
        if (updatedOn != null ? !updatedOn.equals(drugForm.updatedOn) : drugForm.updatedOn != null) return false;
        if (uuid != null ? !uuid.equals(drugForm.uuid) : drugForm.uuid != null) return false;
        if (voidReason != null ? !voidReason.equals(drugForm.voidReason) : drugForm.voidReason != null) return false;
        if (voidedBy != null ? !voidedBy.equals(drugForm.voidedBy) : drugForm.voidedBy != null) return false;
        if (voidedOn != null ? !voidedOn.equals(drugForm.voidedOn) : drugForm.voidedOn != null) return false;
