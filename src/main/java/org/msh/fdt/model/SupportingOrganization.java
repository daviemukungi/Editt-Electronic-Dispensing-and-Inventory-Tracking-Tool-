 ...
 */
@Entity
@Table(name = "supporting_organization", schema = "", catalog = "fdt")
public class SupportingOrganization {
    ...
    private Collection<DrugSupportingOrganization> drugSupportingOrganizationsById;
    ...
    public boolean equals(Object o) {
        ...
        SupportingOrganization that = (SupportingOrganization) o;
    ...
    @OneToMany(mappedBy = "supportingOrganizationBySupportingOrganizationId")
    public Collection<DrugSupportingOrganization> getDrugSupportingOrganizationsById() {
        return drugSupportingOrganizationsById;
    }

    public void setDrugSupportingOrganizationsById(Collection<DrugSupportingOrganization> drugSupportingOrganizationsById) {
        this.drugSupportingOrganizationsById = drugSupportingOrganizationsById;
    }
