 ...
 */
@Entity
@Table(name = "transaction_type", schema = "", catalog = "fdt")
public class TransactionType {
    private int id;
    private String name;
    private String description;
    private byte documentable;
    private byte narrated;
    ...
    private Collection<AccountTypeTransactionType> accountTypeTransactionTypesById;
    ...
    @Basic
    @Column(name = "documentable", nullable = false, insertable = true, updatable = true)
    public byte getDocumentable() {
        return documentable;
    }

    public void setDocumentable(byte documentable) {
        this.documentable = documentable;
    }

    @Basic
    @Column(name = "narrated", nullable = false, insertable = true, updatable = true)
    public byte getNarrated() {
        return narrated;
    }

    public void setNarrated(byte narrated) {
    ...
    public boolean equals(Object o) {
        ...
        if (documentable != that.documentable) return false;
        if (id != that.id) return false;
        if (narrated != that.narrated) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) documentable;
        result = 31 * result + (int) narrated;
    ...
    public Collection<AccountTypeTransactionType> getAccountTypeTransactionTypesById() {
        return accountTypeTransactionTypesById;
    }

    public void setAccountTypeTransactionTypesById(Collection<AccountTypeTransactionType> accountTypeTransactionTypesById) {
        this.accountTypeTransactionTypesById = accountTypeTransactionTypesById;
    }
