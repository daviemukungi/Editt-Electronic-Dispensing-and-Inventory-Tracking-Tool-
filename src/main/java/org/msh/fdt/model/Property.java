 ...
 */
@Entity
@Table(name = "property", schema = "", catalog = "fdt")
public class Property {
    ...
    @Basic
    @Column(name = "`key`", nullable = false, insertable = true, updatable = true, length = 45)
    ...
    public boolean equals(Object o) {
        ...
        if (createdBy != property.createdBy) return false;
        if (id != property.id) return false;
        if (voided != property.voided) return false;
        if (createdOn != null ? !createdOn.equals(property.createdOn) : property.createdOn != null) return false;
        ...
        if (updatedBy != null ? !updatedBy.equals(property.updatedBy) : property.updatedBy != null) return false;
        if (updatedOn != null ? !updatedOn.equals(property.updatedOn) : property.updatedOn != null) return false;
        ...
        if (voidReason != null ? !voidReason.equals(property.voidReason) : property.voidReason != null) return false;
        if (voidedBy != null ? !voidedBy.equals(property.voidedBy) : property.voidedBy != null) return false;
        if (voidedOn != null ? !voidedOn.equals(property.voidedOn) : property.voidedOn != null) return false;
