...
/**
 * Created by kenny on 9/27/14.
 */
@Entity
@Table(name = "visit_type", schema = "", catalog = "fdt")
public class VisitType {
    ...
    public boolean equals(Object o) {
        ...
        if (createdBy != visitType.createdBy) return false;
        if (id != visitType.id) return false;
        if (standard != visitType.standard) return false;
        if (voided != visitType.voided) return false;
        if (createdOn != null ? !createdOn.equals(visitType.createdOn) : visitType.createdOn != null) return false;
        if (description != null ? !description.equals(visitType.description) : visitType.description != null)
            return false;
        if (legacyPk != null ? !legacyPk.equals(visitType.legacyPk) : visitType.legacyPk != null) return false;
        if (name != null ? !name.equals(visitType.name) : visitType.name != null) return false;
        if (serviceTypeId != null ? !serviceTypeId.equals(visitType.serviceTypeId) : visitType.serviceTypeId != null)
            return false;
        if (updatedBy != null ? !updatedBy.equals(visitType.updatedBy) : visitType.updatedBy != null) return false;
        if (updatedOn != null ? !updatedOn.equals(visitType.updatedOn) : visitType.updatedOn != null) return false;
        if (uuid != null ? !uuid.equals(visitType.uuid) : visitType.uuid != null) return false;
        if (voidReason != null ? !voidReason.equals(visitType.voidReason) : visitType.voidReason != null) return false;
        if (voidedBy != null ? !voidedBy.equals(visitType.voidedBy) : visitType.voidedBy != null) return false;
        if (voidedOn != null ? !voidedOn.equals(visitType.voidedOn) : visitType.voidedOn != null) return false;
