 ...
 */
@Entity
@Table(name = "service_type", schema = "", catalog = "fdt")
public class ServiceType {
    ...
    @Basic
    @Column(name = "service_area", nullable = false, insertable = true, updatable = true, length = 255)
    ...
    public boolean equals(Object o) {
        ...
        if (service_area != null ? !service_area.equals(that.service_area) : that.service_area != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (service_area != null ? service_area.hashCode() : 0);
