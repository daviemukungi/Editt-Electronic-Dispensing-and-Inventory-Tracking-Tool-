 ...
 */
@Entity
@Table(name = "facility", schema = "", catalog = "fdt")
public class Facility {
    ...
    @Basic
    @Column(name = "district", nullable = false, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "county", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "region", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    public boolean equals(Object o) {
        ...
        if (code != facility.code) return false;
        if (createdBy != facility.createdBy) return false;
        if (id != facility.id) return false;
        if (standard != facility.standard) return false;
        if (voided != facility.voided) return false;
        if (address != null ? !address.equals(facility.address) : facility.address != null) return false;
        if (county != null ? !county.equals(facility.county) : facility.county != null) return false;
        if (createdOn != null ? !createdOn.equals(facility.createdOn) : facility.createdOn != null) return false;
        if (district != null ? !district.equals(facility.district) : facility.district != null) return false;
        ...
        if (updatedBy != null ? !updatedBy.equals(facility.updatedBy) : facility.updatedBy != null) return false;
        if (updatedOn != null ? !updatedOn.equals(facility.updatedOn) : facility.updatedOn != null) return false;
        if (uuid != null ? !uuid.equals(facility.uuid) : facility.uuid != null) return false;
        if (voidReason != null ? !voidReason.equals(facility.voidReason) : facility.voidReason != null) return false;
        if (voidedBy != null ? !voidedBy.equals(facility.voidedBy) : facility.voidedBy != null) return false;
        if (voidedOn != null ? !voidedOn.equals(facility.voidedOn) : facility.voidedOn != null) return false;
