 ...
 */
@Entity
@Table(name = "role", schema = "", catalog = "fdt")
public class Role {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        if (voided != role.voided) return false;
        ...
        if (updatedOn != null ? !updatedOn.equals(role.updatedOn) : role.updatedOn != null) return false;
        if (uuid != null ? !uuid.equals(role.uuid) : role.uuid != null) return false;
        if (voidReason != null ? !voidReason.equals(role.voidReason) : role.voidReason != null) return false;
        if (voidedBy != null ? !voidedBy.equals(role.voidedBy) : role.voidedBy != null) return false;
        if (voidedOn != null ? !voidedOn.equals(role.voidedOn) : role.voidedOn != null) return false;
