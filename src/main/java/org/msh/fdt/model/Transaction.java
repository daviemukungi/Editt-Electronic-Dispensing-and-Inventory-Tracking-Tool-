 ...
 */
@Entity
@Table(name = "transaction", schema = "", catalog = "fdt")
public class Transaction {
    ...
    private Indication indicationByIndicationId;
    ...
    @Basic
    @Column(name = "transaction_type_id", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "reference_no", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "visit_id", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "prescription_id", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "indication_id", nullable = true, insertable = true, updatable = true)
    ...
    public boolean equals(Object o) {
        ...
        if (indicationId != null ? !indicationId.equals(that.indicationId) : that.indicationId != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (indicationId != null ? indicationId.hashCode() : 0);
    ...
    @ManyToOne
    @JoinColumn(name = "transaction_type_id", referencedColumnName = "id", insertable=false, updatable=false)
    ...
    @ManyToOne
    @JoinColumn(name = "indication_id", referencedColumnName = "id", insertable=false, updatable=false)
    public Indication getIndicationByIndicationId() {
        return indicationByIndicationId;
    }

    public void setIndicationByIndicationId(Indication indicationByIndicationId) {
        this.indicationByIndicationId = indicationByIndicationId;
    }
