 ...
 */
@Entity
@Table(name = "dispensing_unit", schema = "", catalog = "fdt")
public class DispensingUnit {
    ...
    @Basic
    @Column(name = "minimum", nullable = true, insertable = true, updatable = true, precision = 2)
    ...
    @Basic
    @Column(name = "maximum", nullable = true, insertable = true, updatable = true, precision = 2)
    ...
    public boolean equals(Object o) {
        ...
        DispensingUnit that = (DispensingUnit) o;
