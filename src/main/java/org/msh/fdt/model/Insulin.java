 ...
 */
@Entity
@Table(name = "insulin", schema = "", catalog = "fdt")
public class Insulin {
    ...
    public boolean equals(Object o) {
        ...
        if (createdBy != insulin.createdBy) return false;
        if (id != insulin.id) return false;
        if (voided != insulin.voided) return false;
        if (createdOn != null ? !createdOn.equals(insulin.createdOn) : insulin.createdOn != null) return false;
        if (description != null ? !description.equals(insulin.description) : insulin.description != null) return false;
        if (name != null ? !name.equals(insulin.name) : insulin.name != null) return false;
        if (updatedBy != null ? !updatedBy.equals(insulin.updatedBy) : insulin.updatedBy != null) return false;
        if (updatedOn != null ? !updatedOn.equals(insulin.updatedOn) : insulin.updatedOn != null) return false;
        if (uuid != null ? !uuid.equals(insulin.uuid) : insulin.uuid != null) return false;
        if (voidReason != null ? !voidReason.equals(insulin.voidReason) : insulin.voidReason != null) return false;
        if (voidedBy != null ? !voidedBy.equals(insulin.voidedBy) : insulin.voidedBy != null) return false;
        if (voidedOn != null ? !voidedOn.equals(insulin.voidedOn) : insulin.voidedOn != null) return false;
    ...
    @ManyToOne
    @JoinColumn(name = "voided_by", referencedColumnName = "id", nullable = false, insertable=false, updatable=false)
