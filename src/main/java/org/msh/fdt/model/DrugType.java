 ...
 */
@Entity
@Table(name = "drug_type", schema = "", catalog = "fdt")
public class DrugType {
    ...
    public boolean equals(Object o) {
        ...
        if (createdBy != drugType.createdBy) return false;
        if (id != drugType.id) return false;
        if (voided != drugType.voided) return false;
        if (createdOn != null ? !createdOn.equals(drugType.createdOn) : drugType.createdOn != null) return false;
        if (description != null ? !description.equals(drugType.description) : drugType.description != null)
            return false;
        if (name != null ? !name.equals(drugType.name) : drugType.name != null) return false;
        if (updatedBy != null ? !updatedBy.equals(drugType.updatedBy) : drugType.updatedBy != null) return false;
        if (updatedOn != null ? !updatedOn.equals(drugType.updatedOn) : drugType.updatedOn != null) return false;
        if (uuid != null ? !uuid.equals(drugType.uuid) : drugType.uuid != null) return false;
        if (voidReason != null ? !voidReason.equals(drugType.voidReason) : drugType.voidReason != null) return false;
        if (voidedBy != null ? !voidedBy.equals(drugType.voidedBy) : drugType.voidedBy != null) return false;
        if (voidedOn != null ? !voidedOn.equals(drugType.voidedOn) : drugType.voidedOn != null) return false;
